...
class HDIBase {
  ...
  constructor(credentials, paramSchema, apiSchema, usehdb) {
    ...
    credentials.user = credentials.hdi_user ? credentials.hdi_user : credentials.user;
    credentials.password = credentials.hdi_user ? credentials.hdi_password : credentials.password;
