  ...
  modifiedAndUnmodifiedFiles.forEach((modifiedAndUnmodifiedFile) => {
    ...
    if (file) {
      if (Buffer.isBuffer(deployFileContent[1])) {
        ...
        emptyStream = false;
      } else if (deployFileContent[1].readableBuffer.head !== undefined && deployFileContent[1].readableBuffer.head !== null)  {
        if (deployFileContent[1].readableBuffer.head.data !== undefined && deployFileContent[1].readableBuffer.head.data !== null) {
